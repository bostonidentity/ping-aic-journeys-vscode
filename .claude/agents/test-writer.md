...
- Add tests that hit a live AIC tenant in the default test run. Live tests are gated behind `PINGAIC_LIVE=1`.
- Mock so aggressively that you're testing the mocks. Mock `axios` at the boundary; let the rest of the AIC client run normally.
